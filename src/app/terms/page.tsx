    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 px-4 py-8 sm:py-12">
      <div className="max-w-4xl mx-auto bg-white dark:bg-slate-900 rounded-2xl shadow p-6 sm:p-8 space-y-6 border border-gray-200 dark:border-slate-800">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">
          QlutchGrid – User Terms & Conditions
        </h1>
        ...
        <div className="space-y-4 text-sm text-gray-700 dark:text-slate-300 leading-6">
          ...
          <p>
            ...
            verification of Service Providers (as detailed in our Partner
            Agreement). However, QlutchGrid does not guarantee, warrant, or
            endorse the accuracy of this verification, or the quality, safety,
            credentials, or legality of any Service Provider or their services.
            You agree that you are responsible for exercising your own judgment
            and discretion in selecting and interacting with Service Providers.
          </p>
          ...
          <p>
            3.1. Account Registration: You must register for an account using
            accurate, current, and complete personal information.
          </p>
          <p>
            3.2. Account Confidentiality: You are solely responsible for
            maintaining the confidentiality of your account, password, and login
            credentials and for all activities that occur under your account.
          </p>
          <p>
            3.3. Lawful Use: You agree to use the Platform only for lawful
            purposes and in compliance with these Terms. You must not:
          </p>
          <p>
            • Misuse the Platform, engage in fraudulent activity, or attempt to
          ...
          <p>
            4.1. Bookings: You can book services offered by listed Service
            Providers through the Platform. All bookings are subject to
            acceptance by the Service Provider.
          </p>
          <p>
            4.2. Pricing and Policies: Pricing, service descriptions,
            availability, and refund or cancellation policies are determined and
            set by each Service Provider, not by QlutchGrid. QlutchGrid simply
            displays this information on the Platform. QlutchGrid reserves the
          ...
          <p>
            ...
            by the specific policy set by the Service Provider, which is
            displayed at the time of booking. QlutchGrid is not responsible for
            refund disputes and will only process refunds upon confirmation and
            approval from the respective Service Provider.
          </p>
          ...
          <p>
            5.2. Responsibility for Content: You are solely responsible for your
            User Content. You represent and warrant that you own all rights to
            your User Content or have the necessary permissions to grant us the
            license described above, and that your User Content does not violate
            any law or infringe upon the rights of any third party.
          </p>
          ...
          <p>• Promotional messages, which you may opt-out of at any time.</p>

          <h2 className="text-base font-semibold text-gray-900 dark:text-slate-100">
            7. Data Collection & Privacy
          </h2>
          <p>
            Your personal information is collected, stored, and processed as per
            our Privacy Policy, which is available on our website and app.
            QlutchGrid complies with the Information Technology Act, 2000, and
          ...
          <p>
            All content, branding, software, and materials on the Platform
            (excluding User Content) are the exclusive intellectual property of
            RideLink Innovations Private Limited. Users are prohibited from
            copying, redistributing, or commercially exploiting any part of the
          ...
          <p>
            ...
            liability (contract, tort, or otherwise).
          </p>
          ...
          <p>
            You agree to indemnify, defend, and hold harmless QlutchGrid, its
            ...
            breach or violation of any of these Terms; (c) your User Content,
            including any claims of infringement; (d) your interactions,
            disputes, or transactions with any Service Provider; or (e) your
          ...
          <p>
            These Terms are governed by the laws of India. Any disputes, claims,
            or controversies arising hereunder shall be subject to the exclusive
            jurisdiction of the competent courts in Chennai, Tamil Nadu.
          </p>
